	...
	function register($category, $path) {
		if (parent::register($category, $path)) {
			if ($this->getEnabled()) {
                ...
                HookRegistry::register('ArticleGalleyDAO::updateGalley', array(&$xmlGalleyDao, 'updateXMLGalleys'));    //New by Peter
                ...
                HookRegistry::register('ArticleGalleyDAO::getLocalizedGalleysByArticle', array(&$xmlGalleyDao, 'appendXMLGalleys'));
	...
	function manage($verb, $args, &$message) {
		...
		switch ($verb) {
			case 'test':
                ...
                error_log("Test external xslt renderer");
